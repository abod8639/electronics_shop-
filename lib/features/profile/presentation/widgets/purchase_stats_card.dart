...
class PurchaseStatsCard extends ConsumerStatefulWidget {
  const PurchaseStatsCard({super.key});

  @override
  ConsumerState<PurchaseStatsCard> createState() => _PurchaseStatsCardState();
}

class _PurchaseStatsCardState extends ConsumerState<PurchaseStatsCard> {
  @override
