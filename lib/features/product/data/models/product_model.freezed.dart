...
class _$ProductModelCopyWithImpl<$Res, $Val extends ProductModel>
  ...
  $Res call({
    ...
    Object? technicalSpecifications = freezed,
    Object? warrantyInfo = freezed,
    Object? colors = null,
...
class _$ProductModelImpl extends _ProductModel {
  ...
  @override
  String toString() {
    return 'ProductModel(id: $id, name: $name, description: $description, brand: $brand, category: $category, imageUrls: $imageUrls, hasVariants: $hasVariants, price: $price, discountPrice: $discountPrice, stockQuantity: $stockQuantity, averageRating: $averageRating, reviewCount: $reviewCount, technicalSpecifications: $technicalSpecifications, warrantyInfo: $warrantyInfo, colors: $colors, productSizes: $productSizes, size: $size, tags: $tags, weight: $weight, isActive: $isActive, isBackgroundWhite: $isBackgroundWhite, featured: $featured, newArrival: $newArrival, bestSeller: $bestSeller, sku: $sku, totalSales: $totalSales, createdAt: $createdAt, updatedAt: $updatedAt, manufacturer: $manufacturer, countryOfOrigin: $countryOfOrigin)';
  }
